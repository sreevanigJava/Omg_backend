...
public class MySecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/api/login","/api/user/sendOtp","/api/user/register","/api/admin/sendOtp","/api/admin/register","/api/admin/getAllProducts","/api/P_Agent/sendOtp","/api/P_Agent/register","/api/P_Agent/myProfile","/api/P_Agent/UPdate","/api/D_Agent/sendOtp","/api/D_Agent/register","/api/D_Agent/myProfile","/api/deliveryBoyLogin","/api/getotp","/api/admin/addCategory","/api/admin/addProducts","/api/admin/getCategories","/api/admin/getAllProducts","/api/admin/updateProd").permitAll().anyRequest().authenticated().and()
